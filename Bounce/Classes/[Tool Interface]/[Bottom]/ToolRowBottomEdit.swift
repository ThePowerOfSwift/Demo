...
class ToolRowBottomEdit: ToolRow
{
    ...
    @IBOutlet weak var mainContainerAltLeft: UIView!
    @IBOutlet weak var mainContainerAltRight: UIView!
    @IBOutlet weak var mainContainerAltLeftEdgeConstraint: NSLayoutConstraint!
    @IBOutlet weak var mainContainerAltRightEdgeConstraint: NSLayoutConstraint!
    ...
    override func setUp() {
        ...
        if ApplicationController.shared.isSceneLandscape {
            ...
            let width = mainContainerAltLeft.frame.size.width
            mainContainerAltLeftEdgeConstraint.constant = -(width + 4.0)
            mainContainerAltRightEdgeConstraint.constant = -(width + 4.0)
            
            mainContainerAltLeft.isHidden = true
            mainContainerAltRight.isHidden = true
