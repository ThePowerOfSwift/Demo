...
class ToolActions {
    ...
    class func navigateBounce(withFile filePath: String) {
        
        ApplicationController.shared.preloadScene(withFile: filePath)
        ...
        if let bounce = ApplicationController.shared.getStoryboardVC("bounce") as? BounceViewController {
            if let nc = ApplicationController.shared.navigationController {
                ...
                bounce.loadScene(filePath: filePath)
    ...
    class func navigateBounce() {
        
        
        
    }
    
    class func navigateHome() {
